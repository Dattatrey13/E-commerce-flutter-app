...
class ActionLayout extends StatelessWidget {
  ...
  const ActionLayout({Key? key, this.firstActionName, this.secondAction, this.firstActionIcon, this.firstActionTap, this.secondActionTap})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AppController>(builder: (appCtrl) {
      return Row(
        ...
        children: [
          Visibility(
            visible: firstActionName == CommonTextFont().moveToCart || firstActionName == "Get a call",
            child: Row(
              children: [
                firstActionIcon!,
                const Space(5, 0),
