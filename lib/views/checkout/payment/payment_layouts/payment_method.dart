import 'package:dapperz/views/checkout/payment/payment_layouts/payment_expandable.dart';
import 'package:dapperz/views/checkout/payment/payment_layouts/payment_expandable_list.dart';
          ...
          ...AppArray().paymentMethodList.asMap().entries.map((e) {
            return GestureDetector(
              ...
              child: PaymentExpandable(
                ...
                child: PaymentExpandableList(data: e.value, index: e.key),
              ),
            );
          }).toList()
        ],
