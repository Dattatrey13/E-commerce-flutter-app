              ...
              Row(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      LatoFontStyle(text: data['title'], fontSize: FontSizes.f12, fontWeight: FontWeight.w600),
                      if (index != 0 && index != 1) LatoFontStyle(text: data['subTitle'], fontSize: FontSizes.f12, fontWeight: FontWeight.normal)
                    ],
                  )
                ],
              ),
