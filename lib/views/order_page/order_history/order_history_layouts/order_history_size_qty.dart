    ...
    return GetBuilder<AppController>(builder: (appCtrl) {
      return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          // const Space(10, 0),
          OrderHistoryWidget().commonText("Item:"),
          const Space(5, 0),
          OrderHistoryWidget().commonText(daysWiseList!.qty.toString()),
        ]),
        const Space(0, 5),
        OrderHistoryWidget().viewDetailText(daysWiseList!.status, daysWiseList!.deliveryStatus),
      ]).marginOnly(
          left: AppScreenUtil().screenWidth(appCtrl.isRTL || appCtrl.languageVal == "ar" ? 0 : 15),
          right: AppScreenUtil().screenWidth(appCtrl.isRTL || appCtrl.languageVal == "ar" ? 15 : 0));
    });
  }
}
