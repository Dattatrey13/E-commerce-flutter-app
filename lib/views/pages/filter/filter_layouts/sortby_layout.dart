    ...
    return GetBuilder<AppController>(builder: (appCtrl) {
      return DecoratedBox(
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(AppScreenUtil().borderRadius(5)), //border raiuds of dropdown button
        ),
        child: Padding(
          padding: EdgeInsets.symmetric(horizontal: AppScreenUtil().screenWidth(25)),
