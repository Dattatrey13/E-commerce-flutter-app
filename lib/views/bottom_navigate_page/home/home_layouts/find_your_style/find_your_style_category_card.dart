...
class FindYourStyleCategoryCard extends StatelessWidget {
  // final List<int>? selectedStyleCategory;
  ...
  const FindYourStyleCategoryCard({Key? key, this.index, this.selectedStyleCategory, this.data, this.onTap, this.isHomePage = true})
      : super(key: key);
      ...
      return InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: selectedStyleCategory == index ? appCtrl.appTheme.primary : appCtrl.appTheme.lightGray,
